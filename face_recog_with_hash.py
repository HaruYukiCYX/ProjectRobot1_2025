...
anchor = (0.1075, 0.126875, 0.126875, 0.175, 0.1465625, 0.2246875, 0.1953125, 0.25375,
          0.2440625, 0.351875, 0.341875, 0.4721875, 0.5078125, 0.6696875, 0.8984375,
        ...
        for l in dect:
            ...
            if len(scores):
                ...
                if max_score > THRESHOLD:
                    img.draw_string(0, 195, "person:%d,score:%2.1f" % (index, max_score),
            ...
            if start_processing:
                h = hash_feature_safe(feature)
                if h:
                    print("Face registered with hash:", h[:8])
                    record_hashes.append(h)
                record_ftrs.append(feature)
                print("record_ftrs count:", len(record_ftrs))
                start_processing = False
